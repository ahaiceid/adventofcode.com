...
class TestSolver(unittest.TestCase):
    ...
    def test_detector_perimeter_position_generator(self):
        sensor_detector_checker = solver.SensorDetectionChecker(*self.sample_sensor_reports[6])
        positions = [x for x in solver.detector_perimeter_position_generator(sensor_detector_checker)]
        expected_positions = [(17, 8), (16, 9), (15, 10), (14, 11), (13, 12), (12, 13), (11, 14),
                              (10, 15), (9, 16), (8, 17), (7, 16), (6, 15), (5, 14), (4, 13),
                              (3, 12), (2, 11), (1, 10), (0, 9), (-1, 8), (-2, 7), (-1, 6), (0, 5),
                              (1, 4), (2, 3), (3, 2), (4, 1), (5, 0), (6, -1), (7, -2), (8, -3),
                              (9, -2), (10, -1), (11, 0), (12, 1), (13, 2), (14, 3), (15, 4),
                              (16, 5), (17, 6), (18, 7)]
